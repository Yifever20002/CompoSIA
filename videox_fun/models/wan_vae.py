...
class AutoencoderKLWan_(nn.Module):
    ...
    def encode(self, x, scale):
        ...
        ## Split the encoder input along time as 1, 4, 4, 4, ...
...
def _video_vae(z_dim=None, temperal_downsample=[False, True, True], **kwargs):
    """
    ...
    cfg = dict(
        ...
        num_res_blocks=2,
        attn_scales=[],
        temperal_downsample=temperal_downsample,  # [False, True, True],  # [False, False, False],  
        dropout=0.0)
    cfg.update(**kwargs)
...
class AutoencoderKLWan(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        elif temporal_compression_ratio == 4:
            temperal_downsample = [False, True, True]
        else:
            raise NotImplementedError(
                "Only temporal_compression_ratio 1 and 4 are supported."
            )
    ...
    def from_pretrained(cls, pretrained_model_path, additional_kwargs={}):
        ...
        elif pretrained_model_path.endswith("pkl"):
            state_dict = torch.load(pretrained_model_path, map_location="cpu")["model"]
        else:
